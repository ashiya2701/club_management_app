...
class _DetailsState extends State<Details> {
  ...
  Widget _buildTF(String x, String y,TextEditingController controller,Color myclr) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            x, style: TextStyle(color: myclr, fontFamily: 'Poppins', fontSize: 20),
          ),
          SizedBox(height: 5.0),
          Container(
            ...
            child: TextField(
              ...
              style: TextStyle(color: myclr, fontFamily: 'Poppins',fontSize:15),
        ...
        child: Expanded(
          child: Column(
            ...
            children: [
              ...
              _buildTF('Topic', "What's the session about?" ,name, Colors.white),
              const SizedBox(height: 20,),
          ...
          decoration: BoxDecoration(
            ...
            child: Expanded(
              child: Column(
                children:[
                  _buildTF('Start-Time', '4:00 pm', start_time, Colors.black),
                  const SizedBox(height: 20,),
