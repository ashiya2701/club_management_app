...
class ShowHalls1 extends StatefulWidget {
  const ShowHalls1({Key? key}) : super(key: key);

  @override
  State<ShowHalls1> createState() => _ShowHalls1();
}

class _ShowHalls1 extends State<ShowHalls1> {
          ...
          children: [
            ...
            Expanded(
              child: GridView.count(
                crossAxisCount: 3,
                children: List.generate(11, (index){return GestureDetector(onTap: () {
                  setState(() {
